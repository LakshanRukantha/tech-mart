...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2024 at 01:28 PM
...
CREATE TABLE `orders` (
  ...
  `ordering_email` varchar(255) DEFAULT NULL,
...
(1, 'rukanthalakshan@gmail.com', 'Lakshan Rukantha', '12345', 'admin');
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`user_email`) REFERENCES `users` (`email`) ON DELETE CASCADE;
